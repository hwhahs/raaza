...
auth_grp = environ.get('-1002728293319')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002728293319')
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/moviereview365p')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+Y9NcU3DhpvY0YTc1')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/moviereview365p')
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : @FoxxyBotz')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL','-1002989367095'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'moviereview365p')

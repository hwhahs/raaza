...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1003174894633')
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1003174894633')
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+MPYqWUWHJcY2OTVl')
